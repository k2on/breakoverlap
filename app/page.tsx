    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-24">
            ...
            <ul className="flex flex-col gap-2">
                {selected.map(id => (
                    <li className="flex flex-row justify-center gap-2"><Colleges value={id} colleges={[...validColleges, COLLAGES.find(c => c.value == id)!]} onSelect={onSelect} /><Button onClick={() => onRemove(id)} variant="outline"><XIcon size={15}/></Button></li>
                ))}
